...
df_circuits = spark.read.options(header=True,delimeter=',').schema(circuits_schema).csv('/mnt/sadevadls1/raw/circuits.csv')
...
## df_circuits.write.mode('overwrite').parquet('/mnt/sadevadls1/processed/circuits')
...
display(spark.read.parquet('/mnt/sadevadls1/processed/circuits'))
...
df_races = spark.read.options(header='true', delimiter=',').schema(races_schema).csv('/mnt/sadevadls1/raw/races.csv')
...
##df_races.write.mode('overwrite').parquet("/mnt/sadevadls1/processed/races")
...
display(dbutils.fs.ls("/mnt/sadevadls1/processed/races"))

# COMMAND ----------

#df_races.write.mode('overwrite').partitionBy("race_year").parquet("/mnt/sadevadls1/processed/races")
