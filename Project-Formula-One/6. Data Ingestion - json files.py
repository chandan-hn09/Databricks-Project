...
df_constructor = spark.read.schema(constructor_schema).json('/mnt/sadevadls1/raw/constructors.json')
...
#df_constructor.write.mode('overwrite').parquet('/mnt/sadevadls1/processed/constructors')
...
drivers_df = spark.read.schema(drivers_schema).json('/mnt/sadevadls1/raw/drivers.json')
...
##drivers_df.write.mode("overwrite").parquet("/mnt/sadevadls1/processed/drivers")
...
results_df = spark.read.schema(results_schema).json("/mnt/sadevadls1/raw/results.json")
...
#results_df.write.mode("overwrite").partitionBy('race_id').parquet("/mnt/sadevadls1/processed/results")
...
.json("/mnt/sadevadls1/raw/pit_stops.json")
...
##pit_stops_df.write.mode("overwrite").parquet("/mnt/sadevadls1/processed/pit_stops")
...
#display(spark.read.parquet("/mnt/sadevadls1/processed/pit_stops"))
...
.csv("/mnt/sadevadls1/raw/lap_times/lap*.csv")
...
#lap_times_df.write.mode("overwrite").parquet("/mnt/sadevadls1/processed/lap_times")
...
.option("multiLine", True) \
.json("/mnt/sadevadls1/raw/qualifying")
...
#qualifying_df.write.mode("overwrite").parquet("/mnt/sadevadls1/processed/qualifying")
